...
class TESTZG2WIN(unittest.TestCase):
    ...
    def test_article_seven(self):
        ...
        ဤေၾကညာ စာတမ္းပါ သေဘာတရားမ်ားကို ဖီဆန္၍ ခြဲျခားျခင္းမွ လည္းေကာင္း၊ ထိုသို႔ခြဲျခားျခင္းကို လႈံ့ေဆာ္ျခင္းမွ လည္းေကာင္း၊ 
    ...
    def test_article_sixteen(self):
        ...
        မိသားစု တစ္ခုသည္ လူ႔အဖြဲ႕အစည္း၏ သဘာ၀က်ေသာ အေျခခံအဖြဲ႕တစ္ရပ္ျဖစ္သည္၊ ထိုမိသားစုသည္ လူ႔ အဖြဲ႕အစည္းႏွင့္ 
